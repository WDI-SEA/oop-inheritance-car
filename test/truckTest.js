...
var truck = new Truck('Chevy', 'Silverado', 2016, 'black', 3, ['Hank Hill']);
...
assert.strictEqual(truck.seats, 3, 'truck should have a 3 property');
success();

console.log('Testing if truck has passengers property');
