...
var motorcycle = new Motorcycle('Harley', 'Ninja', 1987, 'blue', 2, ['Shane', 'Jermey', 'Alaina', 'Kevin']);
 ...
 assert.deepEqual(motorcycle.passengers, ['Shane', 'Jermey', 'Alaina', 'Kevin'], 'motorcycle should have "passengers" parameter');
 success();
